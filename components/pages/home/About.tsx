...
const About = () => {
  return (
    <section
      id="about"
      className="py-24 bg-background overflow-hidden transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-12">
        <motion.div
          ...
          <span className="text-blue-700 dark:text-blue-400 font-semibold uppercase tracking-wider text-sm">
            About
          </span>
