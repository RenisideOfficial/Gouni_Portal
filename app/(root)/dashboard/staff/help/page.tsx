// src/app/(root)/dashboard/staff/help/page.tsx
"use client";
...
const helpTopics = [
  {
    ...
    description:
      "Guidance on formatting CSV files and publishing semester results.",
  },
  {
    title: "Salary & Allowances",
    description:
      "Information regarding payslip downloads and payment schedules.",
  },
  {
    title: "Student Management",
    description:
      "How to view and export lists of students registered for your courses.",
  },
  {
    title: "Account & Login",
    description:
      "Help with account recovery, login issues, and password resets.",
  },
];

const faqData = [
  {
    question: "How do I format my results CSV file?",
    answer:
      "Download the standard template from the Results page. Ensure it includes columns exactly named: Matric Number, CA Score, and Exam Score. The portal will automatically compute the total and grades.",
  },
  {
    question: "When are payslips generated?",
    answer:
      "Payslips are automatically generated on the 25th of every month. You can download them as a PDF from the Salary module.",
  },
  {
    question: "How do I edit a result after publishing?",
    answer:
      "Once results are published, they are locked. You must submit an 'Amendment Request' to the ICT Directorate or Admin for approval to unlock the course.",
  },
  {
    question: "What should I do if I forget my password?",
    answer:
      "Use the 'Forgot Password' link on the login page. A secure OTP will be sent to your registered staff email address to reset it.",
  },
  {
    question: "How can I export my student list?",
    answer:
      "Navigate to the Students module, select your assigned course, and click the 'Export CSV' button at the top right of the data table.",
  },
];
