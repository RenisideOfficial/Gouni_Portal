// src/app/(root)/dashboard/student/profile/page.tsx
"use client";
        ...
        <form
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                type="text"
                defaultValue="Ngozi Chukwumaobim"
                disabled={!isEditing}
                className="w-full px-4 py-3 rounded-xl border border-input bg-background text-foreground focus:ring-2 focus:ring-blue-900 dark:focus:ring-blue-500 outline-none disabled:opacity-50 disabled:bg-muted"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-foreground mb-1.5">
              ...
              <input
                type="text"
                defaultValue="GOU\U22\CSC\858"
                disabled // Reg numbers generally shouldn't be editable by the student
            ...
            <div className="md:col-span-2">
              ...
              <input
                type="email"
                defaultValue="yourexample4@gmail.com"
                disabled={!isEditing}
                className="w-full px-4 py-3 rounded-xl border border-input bg-background text-foreground focus:ring-2 focus:ring-blue-900 dark:focus:ring-blue-500 outline-none disabled:opacity-50 disabled:bg-muted"
              />
            </div>
            <div>
              ...
              <input
                type="text"
                defaultValue="400"
                disabled // Levels update automatically based on academic progress
                className="w-full px-4 py-3 rounded-xl border border-input bg-muted text-muted-foreground outline-none opacity-60 cursor-not-allowed"
              />
            </div>
            <div>
